		...
		?>
          ...
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li id="sname" class="active"><a href="../faculty/sname.php"><i class="icon-user"></i>Faculty name</a></li>
              <li id="sdaytime"><a href="../faculty/sdaytime.php"><i class="icon-time"></i>Day time</a></li>
              <li id="sroom"><a href="../faculty/sroom.php"><i class="icon-home"></i>Room</a></li>
                ...
                <h3>Search by Name</h3><form class="form-search" method="get" action="../faculty/sname.php">
